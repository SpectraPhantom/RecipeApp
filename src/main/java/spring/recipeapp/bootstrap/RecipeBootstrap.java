package spring.recipeapp.bootstrap;


import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import spring.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Each");
        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Excepted UOM not found!");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Tablespoon");
        if(!tableSpoonUomOptional.isPresent()){
            throw  new RuntimeException("Excepted UOM not found!");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Teaspoon");
        if(!teaSpoonUomOptional.isPresent()){
            throw  new RuntimeException("Excepted UOM not found!");
        }

        Optional<UnitOfMeasure> cupUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Cup");
        if(!cupUomOptional.isPresent()){
            throw  new RuntimeException("Excepted UOM not found!");
        }

        Optional<UnitOfMeasure> pintUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Pint");
        if(!pintUomOptional.isPresent()){
            throw  new RuntimeException("Excepted UOM not found!");
        }

        Optional<UnitOfMeasure> dashUomOptional=unitOfMeasureRepository.findUnitOfMeasureByDescription("Dash");
